<?php
// source: /opt/lampp/htdocs/Projekt/config/common.neon
// source: /opt/lampp/htdocs/Projekt/config/services.neon
// source: /opt/lampp/htdocs/Projekt/config/local.neon
// source: array
...
class Container_70d9831b26 extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'Nette\Database\Explorer' => [['database.default.explorer', '02']],
	...
	public function createService02(): App\Model\MainRepository
	{
		return new App\Model\MainRepository(
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/opt/lampp/htdocs/Projekt/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/opt/lampp/htdocs/Projekt/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('/opt/lampp/htdocs/Projekt/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_70d9831b26
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=Projekt', 'root', 'Bigneko7703+', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_70d9831b26 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/opt/lampp/htdocs/Projekt/temp/cache/latte');
